...
function Collapse() {
    ...
    const boxId1 = useRef(null)
    const boxId2 = useRef(null)
    const boxId3 = useRef(null)
    const boxId4 = useRef(null)
    const boxId5 = useRef(null)
    const onToggleClick = (e) => {
        boxId.current.classList.toggle(styles["question-content-show-add"]);
        boxId1.current.classList.remove(styles["question-content-show-add"]);
        boxId2.current.classList.remove(styles["question-content-show-add"]);
        boxId3.current.classList.remove(styles["question-content-show-add"]);
        boxId4.current.classList.remove(styles["question-content-show-add"]);
        boxId5.current.classList.remove(styles["question-content-show-add"]);
    };
    const onToggleClick1 = (e) => {
        boxId1.current.classList.toggle(styles["question-content-show-add"]);
        boxId.current.classList.remove(styles["question-content-show-add"]);
        boxId2.current.classList.remove(styles["question-content-show-add"]);
        boxId3.current.classList.remove(styles["question-content-show-add"]);
        boxId4.current.classList.remove(styles["question-content-show-add"]);
        boxId5.current.classList.remove(styles["question-content-show-add"]);
    ...
    const onToggleClick2 = (e) => {
        boxId2.current.classList.toggle(styles["question-content-show-add"]);
        boxId1.current.classList.remove(styles["question-content-show-add"]);
        boxId.current.classList.remove(styles["question-content-show-add"]);
        boxId3.current.classList.remove(styles["question-content-show-add"]);
        boxId4.current.classList.remove(styles["question-content-show-add"]);
    ...
    const onToggleClick3 = (e) => {
        boxId3.current.classList.toggle(styles["question-content-show-add"]);
        boxId1.current.classList.remove(styles["question-content-show-add"]);
        boxId2.current.classList.remove(styles["question-content-show-add"]);
        boxId.current.classList.remove(styles["question-content-show-add"]);
        boxId4.current.classList.remove(styles["question-content-show-add"]);
    ...
    const onToggleClick4 = (e) => {
        boxId4.current.classList.toggle(styles["question-content-show-add"]);
        boxId1.current.classList.remove(styles["question-content-show-add"]);
        boxId2.current.classList.remove(styles["question-content-show-add"]);
        boxId3.current.classList.remove(styles["question-content-show-add"]);
        boxId.current.classList.remove(styles["question-content-show-add"]);
    ...
    const onToggleClick5 = (e) => {
        boxId5.current.classList.toggle(styles["question-content-show-add"]);
        boxId1.current.classList.remove(styles["question-content-show-add"]);
        boxId2.current.classList.remove(styles["question-content-show-add"]);
        boxId3.current.classList.remove(styles["question-content-show-add"]);
        boxId4.current.classList.remove(styles["question-content-show-add"]);
    ...
    return <div className={styles["question"]}>
        <div className={styles["question-wrap"]}>
            <div className={styles["question-content"]}>
                ...
                <div className={styles["question-content-dropdown"]}>
                    <div className={styles["question-main"]} onClick={onToggleClick1}>
                        <h6>How much does Netflix cost?</h6>
                        <FontAwesomeIcon icon={faPlus} style={{ fontSize: 10, color: "#fff", width: 20, height: 20 }}></FontAwesomeIcon>
                    </div>
                    <div className={styles["question-content-show"]} ref={boxId1}>
                ...
                <div className={styles["question-content-dropdown"]}>
                    <div className={styles["question-main"]} onClick={onToggleClick2}>
                        <h6>Where can I watch?</h6>
                        <FontAwesomeIcon icon={faPlus} style={{ fontSize: 10, color: "#fff", width: 20, height: 20 }}></FontAwesomeIcon>
                    </div>
                    <div className={styles["question-content-show"]} ref={boxId2}>
                ...
                <div className={styles["question-content-dropdown"]}>
                    <div className={styles["question-main"]} onClick={onToggleClick3}>
                        <h6>How do I cancel?</h6>
                        <FontAwesomeIcon icon={faPlus} style={{ fontSize: 10, color: "#fff", width: 20, height: 20 }}></FontAwesomeIcon>
                    </div>
                    <div className={styles["question-content-show"]} ref={boxId3}>
                ...
                <div className={styles["question-content-dropdown"]}>
                    <div className={styles["question-main"]} onClick={onToggleClick4}>
                        <h6>What can I watch on Netflix?</h6>
                        <FontAwesomeIcon icon={faPlus} style={{ fontSize: 10, color: "#fff", width: 20, height: 20 }}></FontAwesomeIcon>
                    </div>
                    <div className={styles["question-content-show"]} ref={boxId4}>
                ...
                <div className={styles["question-content-dropdown"]}>
                    <div className={styles["question-main"]} onClick={onToggleClick5}>
                        <h6>Is Netflix good for kids?</h6>
                        <FontAwesomeIcon icon={faPlus} style={{ fontSize: 10, color: "#fff", width: 20, height: 20 }}></FontAwesomeIcon>
                    </div>
                    <div className={styles["question-content-show"]} ref={boxId5}>
